...
----
plugins {
  id "de.ethinking.escenic" version "0.9.5"
  // or
  id "de.ethinking.escenic.engine" version "0.9.5"
  // or
  id "de.ethinking.escenic.presentation" version "0.9.5"
  // or
  id "de.ethinking.escenic.studio" version "0.9.5"
}
----
...
----
plugins {
  id "de.ethinking.escenic" version "0.9.5"  //<1>
}
...
dependencies{
      engine 'com.escenic:engine:6.17....'   //<5>  
...
dependencies{
      engine 'com.escenic:engine:6.17.xxxx'
