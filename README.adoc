...
----
plugins {
  id "de.ethinking.escenic" version "0.9.0"
  // or
  id "de.ethinking.escenic.engine" version "0.9.0"
  // or
  id "de.ethinking.escenic.presentation" version "0.9.0"
  // or
  id "de.ethinking.escenic.studio" version "0.9.0"
}
----
...
----
plugins {
  id "de.ethinking.escenic" version "0.9.0"  //<1>
}
...
Other preprocessing attribute are `in-publications` and `not-in-publications`. You can use these on any element
