...
----
plugins {
  id "de.ethinking.escenic" version "0.8.0"
  // or
  id "de.ethinking.escenic.engine" version "0.8.0"
  // or
  id "de.ethinking.escenic.presentation" version "0.8.0"
  // or
  id "de.ethinking.escenic.studio" version "0.8.0"
}
----
...
----
plugins {
  id "de.ethinking.escenic" version "0.8.0"  //<1>
}
...
publication{
 ...
 resourcesHost "production","http://production-host:8080/escenic-admin/publication-resources/"
...
The resources upload Tasks will be created from the configured publication extensions. For every host and publication a task will be created.
